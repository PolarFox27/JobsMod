...
public class ServerJobsData {
    ...
    public static final ItemXPRegistry CRAFTING_ITEMS_XP = new ItemXPRegistry("crafting", Item.getItemFromBlock(Blocks.CRAFTING_TABLE));
    public static final ItemXPRegistry SMELTING_ITEMS_XP = new ItemXPRegistry("smelting", Item.getItemFromBlock(Blocks.FURNACE));
    ...
    public static final EntityXPRegistry KILLING_ENTITY_XP = new EntityXPRegistry("killing", Items.GOLDEN_SWORD);
