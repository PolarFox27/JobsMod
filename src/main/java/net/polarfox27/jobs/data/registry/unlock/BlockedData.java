...
public abstract class BlockedData {
     ...
     */
    protected BlockedData(ByteBuf buf){
    ...
    public static class BlockBlockedData extends BlockedData{
         ...
         * @param buf the buffer where to read
         */
        public BlockBlockedData(ByteBuf buf) {
            super(buf);
    ...
    public static class ItemBlockedData extends BlockedData{
         ...
         * @param buf the buffer where to read
         */
        public ItemBlockedData(ByteBuf buf) {
            super(buf);
        ...
        public boolean matches(ItemStack stack){
            return item == stack.getItem() && (metadata < 0 || metadata == stack.getMetadata());
        }
    }
}
